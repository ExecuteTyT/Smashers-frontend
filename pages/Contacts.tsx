...
const Contacts: React.FC = () => {
  useSeo({
    title: 'Контакты клуба Smashers — бадминтон в Казани, зал',
    description: 'Адрес бадминтонного клуба Smashers в Казани, схема проезда, контакты. Зал для бадминтона, удобная локация. Звоните и приходите — мы ждём вас на корте!',
  });
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 animate-[fadeInUp_1s_ease-out_0.2s_both]">
               ...
               <div className="bg-white border border-gray-200 p-6 sm:p-8 md:p-10 rounded-3xl group hover:scale-[1.02] transition-all duration-300 hover:border-emerald-400 hover:shadow-lg min-h-[300px] md:min-h-[400px] flex flex-col justify-between min-w-0 overflow-hidden">
                  <div className="min-w-0">
                     ...
                     >
                        <p className="font-display font-black text-black text-xl sm:text-2xl md:text-3xl leading-tight mb-2 group-hover/phone:text-emerald-600 transition-colors tracking-tight">
                           +7 919 623-68-88
                        </p>
                     </a>
                     <a 
