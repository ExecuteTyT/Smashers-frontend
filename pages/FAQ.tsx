...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    a: `Нет! Мы выдаем весь необходимый инвентарь: профессиональные ракетки Yonex и воланы. Все включено в стоимость занятия.`
  },
  {
    id: 3,
    category: 'new',
  ...
  },
  {
    ...
    a: "Карты, наличные, СБП. Оплаты долями нет."
  },
  {
    id: 6,
    category: 'payment',
